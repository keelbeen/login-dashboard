                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5 bg-dark">
                                    <div class="card-header">
                                        <h3 class="text-center font-weight-dark my-4 text-light">Add Users</h3>
                                    </div>
                                    <div class="card-body">
                                        <form action="{{url('store')}}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">    
                                                    ...
                                                    <input
                                                        class="form-control py-4  border-0 @error('name') is-invalid @enderror" id="name" required value="{{ old('name') }}"
                                                        id="name"
                                                        type="text"
                                                        name="name"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input
                                                    class="form-control py-4  border-0 @error('username') is-invalid @enderror" id="username" required value="{{ old('username') }}"
                                                    id="username"
                                                    type="text"
                                                    name="username"
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox">
                                                    <small class="d-block text-center mt-3 text-light">Back to Admin? <a href="/admin">Click here!</a></small>
                                                </div>
                                            </div>
                                            <div

                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5 bg-dark">
                                    ...
                                    <div class="card-header">
                                        <h3 class="text-center font-weight-dark my-4 text-light">Login</h3>
                                    </div>
                                    <div class="card-body">
                                        <form action="{{url('proses_login')}}" method="POST" id="logForm">
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox">
                                                    ...
                                                    <small class="d-block text-center mt-1 text-light">Not registered? <a href="/register">Register Now!</a></small>
                                                </div>
                                            </div>
                                            <div
